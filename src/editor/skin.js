...
export const skinHelpers = {
  theme_mode: t(null, 'editor.skin.helper_theme_mode', 'Force light or dark theme for skins that support it (Default, Google Home, Home Assistant, Waveform). "Auto" follows your HA theme setting.'),
